  ...
  return (
    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="mx-auto mb-10 lg:max-w-xl sm:text-center">
        ...
        Discover the talented individuals who make up our dynamic team—each contributing their unique skills and perspectives to our shared success.
        </p>
      </div>
      <div className="grid gap-10 mx-auto lg:grid-cols-2 lg:max-w-screen-lg">
        ...
        <div className="grid sm:grid-cols-3">
          ...
          <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
            ...
            <p className="mb-4 text-xs text-gray-100">Assistant Professor
Department of Humanities</p>
        ...
        {/* <div className="grid sm:grid-cols-3">
          ...
          <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
            <p className="text-lg font-bold">Bailkeri</p>
        ...
        <div className="grid sm:grid-cols-3">
          ...
          <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
            ...
            <p className="mb-4 text-sm tracking-wide text-gray-100">
            Arrange the meeting place and admission to the meeting, prepare an agenda, record minutes and keep the president  and institute informed of any matter which may assist or invalidate proceedings.
            </p>
            <div className="flex items-center space-x-3">
              <a
                href="/"
        ...
        <div className="grid sm:grid-cols-3">
         ...
         <div className="grid sm:grid-cols-3">
          ...
          <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
            ...
            <p className="mb-4 text-sm tracking-wide text-gray-100">
            In my role as the Technical Head, I'm a forward-thinking technologist propelling our cultural community into the digital age.
            </p>
            <div className="flex items-center space-x-3">
              <a
                href="/"
        ...
        <div className="grid sm:grid-cols-3">
          ...
          <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
            ...
            <p className="mb-4 text-xs text-gray-100"> Social Media - Cohead</p>
            <p className="mb-4 text-sm tracking-wide text-gray-100">
            As Co-Head of Social Media, spearheads our digital presence, driving engagement and fostering connections in the virtual realm
            </p>
            <div className="flex items-center space-x-3">
              <a
                href="/"
