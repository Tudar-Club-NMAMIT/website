  ...
  return (
    <div
      ...
      <ul
        ref={scrollerRef}
        className={cn(
          "cursor-pointer flex min-w-full shrink-0 gap-4 py-4 w-max flex-nowrap",
          start && "animate-scroll ",
          pauseOnHover && "hover:[animation-play-state:paused]"
        )}>
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl flex-shrink-0  px-8 md:w-[450px]"
            style={{
              background:
            ...
            <blockquote>
              ...
              <Image src={item.img} width={400} height={450} className="rounded-md " alt="Blog Image"/>
